    ...
    <main class="admin-login-page">
            ...
            <section class="admin-form-panel">
                <div class="login-card">
                    ...
                    <div class="login-card-footer">
                        ...
                        <p class="copyright">
                            © {{ date('Y') }} <strong>MediLeaf.</strong> All rights reserved.
                        </p>
                    </div>
                </div>
            </section>
        ...
        <section class="security-strip">
            <div class="security-feature">
                <div class="security-feature-icon"><i class="bi bi-shield-lock"></i></div>
                <div class="security-feature-copy">
                    <strong>Secure Admin Access</strong>
                    <span>Multi layer authentication keeps your admin portal protected.</span>
                </div>
            </div>

            <div class="security-feature">
                <div class="security-feature-icon"><i class="bi bi-speedometer2"></i></div>
                <div class="security-feature-copy">
                    <strong>Smart Dashboard</strong>
                    <span>Manage patients, appointments and operations from one place.</span>
                </div>
            </div>

            <div class="security-feature">
                <div class="security-feature-icon"><i class="bi bi-person-workspace"></i></div>
                <div class="security-feature-copy">
                    <strong>Staff Management</strong>
                    <span>Control access levels for doctors, staff and administrators.</span>
                </div>
            </div>

            <div class="security-feature">
                <div class="security-feature-icon"><i class="bi bi-clipboard2-pulse"></i></div>
                <div class="security-feature-copy">
                    <strong>Real Time Monitoring</strong>
                    <span>Track appointments, prescriptions and daily activities instantly.</span>
                </div>
            </div>
        </section>
    </main>
