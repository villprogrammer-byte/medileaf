...
<div class="ml-admin-blog-form-grid">
        ...
        <div class="ml-admin-card ml-admin-blog-form-card">
            ...
            <div class="ml-admin-blog-form-body">
                ...
                @if($post?->featured_image)
                    ...
                    <a href="{{ route('admin.blog.gallery.index') }}" class="ml-featured-gallery-link"
                        title="Open in Blog Gallery">

                        <div class="ml-featured-gallery-preview">

                            <img src="{{ asset('storage/' . ltrim($post->featured_image, '/')) }}"
                                alt="{{ $post->featured_image_alt ?: $post->title }}" class="ml-featured-preview">
                ...
                @else
                    ...
                    <div class="mb-4">
                        ...
                        <label class="ml-upload-box" id="featuredUpload" for="featuredImageInput">

                            <input type="file" name="featured_image" id="featuredImageInput" accept=".webp,image/webp"
                                hidden>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="featured_image_name" value="{{ old(
    'featured_image_name',
    ...
    ?: (
        ...
        : ''
                    ...
                    @error('featured_image_name') is-invalid @enderror"
                        placeholder="e.g. natural-remedies-for-common-cold">

                    <div class="ml-admin-blog-help">
                        Use a short descriptive image name without the file extension.
                    </div>
                ...
                <div>
                    ...
                    <input type="text" name="featured_image_alt" value="{{ old(
    'featured_image_alt',
    $post?->featured_image_alt
) }}" class="form-control ml-admin-input
                    @error('featured_image_alt') is-invalid @enderror"
                        placeholder="Describe what is shown in the image">

                    <div class="ml-admin-blog-help">
                        Describe the image clearly for accessibility and search engines.
                    </div>
