...
@section('content')
    ...
    <div class="ml-admin-page-head">
        <div>
            <h1>All Products</h1>
            <p>Manage MediLeaf products, colour variants and stock.</p>
        </div>
                        ...
                        <tr>
                            <td>
                                <div class="ml-product-cell">
                                    ...
                                    <div>
                                        <h6>{{ $product->name }}</h6>
                                        <small>SKU: {{ $product->sku ?: 'Not added' }}</small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                @else
                                    <strong>A${{ number_format($product->regular_price, 2) }}</strong>
                                @endif
                            </td>
                            <td>{{ $product->variants_count }} Colours</td>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.products.show', $product) }}"
                                    class="ml-action-btn view" title="View Product">
                                    <i class="bi bi-eye"></i>
                                </a>

                                <a href="{{ route('admin.products.edit', $product) }}"
                                    class="ml-action-btn edit" title="Edit Product">
